...
% PARAMETERS
% ----------
% confusionMat -- nClasses x nClasses confusion matrix. The i_th j_th
%                 element belongs to class i and was predicted to be a
%                 member of class j.
%
% RETURNS
% -------
...
%              i_th element is the f-measure of the i_th class.
%
